 ...
 * 
 * - Drops all vms_unit_* databases
 * - Clears all central DB data (orgs, units, users, logs, OTPs)
 * - Keeps schema and lookup tables (roles, visitor_types)
 */
'use strict';
...
async function reset() {
  ...
  console.log('    Open the app → you will be taken to first-time setup.\n');
}
